...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Adil_Voyage_f037e8363a54fc255467_20230104133019_archive.zip';
        const ARCHIVE_SIZE       = '54403107';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'f037e83-04133019';
        const SECONDARY_PACKAGE_HASH = 'fea7942-04133019';
        const VERSION            = '1.5.1';
